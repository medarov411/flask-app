...
from flask import Flask, jsonify, render_template, request, g, abort, send_file
...
if __name__ == "__main__":
    ...
    if not os.path.exists(app.database):
        with sqlite3.connect(app.database) as connection:
            ...
            c.execute('INSERT INTO shop_items VALUES("cake", "40", "110")')
            c.execute('INSERT INTO shop_items VALUES("coffee", "100", "10")')
            c.execute('INSERT INTO shop_items VALUES("broccoli", "34", "120")')
            c.execute('INSERT INTO shop_items VALUES("onion", "12", "110")')
            c.execute('INSERT INTO shop_items VALUES("tomato", "210", "10")')
            c.execute('INSERT INTO shop_items VALUES("potato", "200", "90")')
            c.execute('INSERT INTO shop_items VALUES("pizza", "90", "70")')
            c.execute('INSERT INTO employees VALUES("admin", "{}")'.format(hash_pass("jasper")))
            connection.commit()
            connection.close()
